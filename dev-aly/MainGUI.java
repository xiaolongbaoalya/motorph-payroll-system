...
public class MainGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(240, 240, 240, 200));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel2.setText("Welcome to MotorPH Payroll System!");

        loginButton.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        loginButton.setText("Employee");
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 310, 280, 100));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/backdrop.png"))); // NOI18N
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        if (input == null || input.trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "No Employee Number entered.", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        try {
            ...
            EmployeeService employeeService = new EmployeeService(loader.getEmployees());
            Employee employee = employeeService.findEmployeeByNumber(empNum);

            if (employee != null) {
                JOptionPane.showMessageDialog(this, "Login successful! Welcome " + employee.getFullName() + ".");

                new MainGUI().setVisible(true); // open the dashboard window
