...
//Change color of the button to 0x1c3680 to match motorPH's logo. We can also add the logo if needed
   ...
   private void adminLogin() { //this is the code for admin login
    ...
    private void showDetailedEmployeeDialog(Component parent, Employee emp) { // Once the view employee button is clicked this is the code for the dialog
        ...
        // This is the space before the payroll period selection
        panel.add(Box.createVerticalStrut(10));
        panel.add(new JLabel("Select Payroll Period:"));

        // This should show dropdowns buttons sidebyside
        JPanel dropdownPanel = new JPanel(new FlowLayout(FlowLayout.LEFT, 10, 0));

        String[] allMonths = new DateFormatSymbols().getMonths();
        String[] months = Arrays.copyOf(allMonths, 12);
        ...
        // As requested, we should place the button below the dropdown code
        ...
        calcBtn.addActionListener(e -> {
            try {
                ...
                payrollForLabel.setForeground(Color.BLACK);
                ...
                payrollForLabel.setText("Invalid Date Selection");
                payrollForLabel.setForeground(Color.RED);
                grossLabel.setText("");
                netLabel.setText("");
            }
        });
    ...
    private void showUpdateDeleteEmployeeList(Component parent) {
        ...
        deleteBtn.addActionListener(e -> {
            ...
            yesBtn.setBackground(new Color(0x1c3680));
            noBtn.setBackground(new Color(0x1c3680));
    ...
    JPanel buttonPanel = new JPanel(new FlowLayout(FlowLayout.RIGHT));
    buttonPanel.setBorder(BorderFactory.createEmptyBorder(0, 5, 5, 5)); // ✅ Added padding around the button
    buttonPanel.add(okButton);
