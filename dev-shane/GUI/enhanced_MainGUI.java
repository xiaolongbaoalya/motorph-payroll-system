...
//I added MotorPH Logo
    private ImageIcon loadLogoIcon() {
        try {
            java.net.URL imgURL = getClass().getClassLoader().getResource("motorph_logo.png");
            if (imgURL != null) {
 ...
 //Also enhanced the button to match with MotorPH's logo
...
//Adjusted the size of the Dashboard and added "Basic Information" as header
